...
- **日記管線的任何改動**（2026-09-06 改寫：原為「不修窗口機制、決定不動」；使用者當日拍板另立「日記品質線 V1」`task-20260906-diary-quality` 與本專案平行，日記的輸入組裝與 prompt 分層在該線做、不在本專案內做。理由：日記是本專案上游，但兩線驗證必須分開，否則 Learned Self 的觀測結果歸因不了）
...
- 2026-09-06 — Out of Scope 改寫：日記管線改動另立工作線 → [handoff](../../handoff/session-handoff-20260906.md)
